...
export class NFTMarketplace__getListingItemResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class NFTMarketplace extends ethereum.SmartContract {
  ...
  getListingItem(
    nftAddress: Address,
    tokenId: BigInt
  ): NFTMarketplace__getListingItemResultValue0Struct {
    let result = super.call(
      "getListingItem",
      "getListingItem(address,uint256):((uint256,address))",
      [
    ...
    return changetype<NFTMarketplace__getListingItemResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListingItem(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<NFTMarketplace__getListingItemResultValue0Struct> {
    let result = super.tryCall(
      "getListingItem",
      "getListingItem(address,uint256):((uint256,address))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<NFTMarketplace__getListingItemResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
